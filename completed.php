...
<html lang="en">
        ...
        $a_result = mysqli_query($con, "SELECT * FROM appointment WHERE doctor_id LIKE '$doctor_id' AND appointment_status = 'Completed' ORDER BY appointment_id") or die(mysqli_error());
    ...
    <body class="e4e8e9-bg">
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown active tooltip-right" data-tooltip="History">
