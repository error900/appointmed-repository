  ...
  <body>
    <div class="container">
        <?php 
            ...
            $p_result = mysqli_query($con, "SELECT * FROM appointment WHERE patient_id LIKE '$patient_id' AND (appointment_status = 'Inqueue' OR appointment_status = 'Referred') AND (appoint_date >= '$start' AND appoint_date <= '$end')" );
            ...
            <div class="row">
                ...
                echo '<div class="col-md-12">
                    ...
                    echo "<div class='panel panel-default' id='asd'><div class='panel-heading appointment-date' >";
                            ...
                            <a class='btn btn-block btn-inverse appo tooltip' data-toggle='modal' data-target='.bs-example-modal-sm' data-id='".$app_id."' data-doctor-id='".$doctor."' data-patient-id='".$patient_id."'   title='edit this appointment'><span title='asdsad'><i class='fa fa-pencil'></i></span> Edit</a>";
