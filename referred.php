  ...
  <head>
    ...
    ?>
     <?php 
        ...
        $a_result = mysqli_query($con, "SELECT * FROM appointment WHERE doctor_id LIKE '$doctor_id' AND appointment_status = 'Referred' ORDER BY appointment_id");
    ?>
     <body class="fff-bg">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active dropdown"><a href="referred.php">Referred</a></li>
                </ul>
           ...
           <div class="col-md-12">
                <h2 class="text-center text-turquoise sched-h">&mdash; Referred &mdash;</h2>
            </div>
        <?php
