...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2015 at 01:14 AM
...
('75', '', '2015Geronimo', '2015Tayab', '0000-00-00', 'Inqueue', 291),
...
CREATE TABLE IF NOT EXISTS `appointment_history` (
  `appointment_history_id` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `notification` (
  `indicator` enum('patient','doctor') NOT NULL,
  `doctor_id` varchar(30) NOT NULL,
  `patient_id` varchar(30) NOT NULL,
...
ALTER TABLE `appointment_history`
  ...
  ADD CONSTRAINT `appointment_history_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`);
...
ALTER TABLE `notification`
  ADD CONSTRAINT `notification_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`),
  ADD CONSTRAINT `notification_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`),
  ADD CONSTRAINT `notification_ibfk_3` FOREIGN KEY (`notif_id`) REFERENCES `notif_legend` (`notif_id`);
...
ALTER TABLE `referred`
  ADD CONSTRAINT `referred_ibfk_1` FOREIGN KEY (`referred_id`) REFERENCES `doctor` (`doctor_id`),
  ADD CONSTRAINT `referred_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`),
  ADD CONSTRAINT `referred_ibfk_3` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`);
...
ALTER TABLE `secretary`
  ...
  ADD CONSTRAINT `secretary_ibfk_2` FOREIGN KEY (`username`) REFERENCES `account` (`username`) ON UPDATE CASCADE;
