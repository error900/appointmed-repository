<div class="col-xs-6 col-md-2 col-md-offset-1">
    <div class="text-center circle inqueue">
     <?php
        $count_row = mysqli_query($con, "SELECT * FROM appointment NATURAL JOIN queue_notif  WHERE doctor_id = '$doctor_id' AND clinic_id = '$clinic_id' AND (appointment_status = 'Inqueue' OR appointment_status = 'Referred') AND appoint_date = '$date' ");
...
<div class="col-xs-6 col-md-2">
    <div class="text-center circle served">
        <?php
        $count_row1 = mysqli_query($con, "SELECT * FROM appointment NATURAL JOIN queue_notif WHERE doctor_id = '$doctor_id' AND clinic_id = '$clinic_id' AND appointment_status = 'Completed' AND appoint_date = '$date' ");
